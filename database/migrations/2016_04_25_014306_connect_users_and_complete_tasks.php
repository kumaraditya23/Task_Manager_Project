...
class ConnectUsersAndCompleteTasks extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('complete_tasks', function (Blueprint $table) {
    ...
    public function down()
    {
        Schema::table('complete_tasks', function (Blueprint $table) {
            ...
            $table->dropForeign('complete_tasks_user_id_foreign');
